...
[Note: since the free version of ngrok inserts an interstitual, you will need to upgrade to the paid ngrok plan to use it with the Warpcast developer tool.]
